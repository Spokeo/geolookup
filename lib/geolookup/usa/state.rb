...
module Geolookup
  module USA
    module State
      STATE_CODE_TO_FULL_FILE         = 'STATE_CODE_TO_NAME.yml'
      STATE_CODE_TO_ABBREVIATION_FILE = 'STATE_CODE_TO_ABBR.yml'
      STATE_NAME_TO_CODE_FILE         = 'STATE_NAME_TO_CODE.yml'
      STATE_ABBREVIATION_TO_NAME_FILE = 'STATE_ABBR_TO_NAME.yml'
